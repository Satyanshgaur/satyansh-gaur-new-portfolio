...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'A full-stack productivity application with real-time updates, user authentication, and collaborative features. Built with modern web technologies and optimized for performance.',
